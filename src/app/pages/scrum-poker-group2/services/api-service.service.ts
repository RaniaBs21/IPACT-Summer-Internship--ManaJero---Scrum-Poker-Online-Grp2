...
// ************************ steps services ****************************
  ...
  getVoteFrequencyBYIssueAndSession(sessionId: string, issueId: string): Observable<Map<string, number>> {
    return this.httpClient.get<Map<string, number>>(`${this.API_URL}/votes/sessions/${sessionId}/issues/${issueId}/vote-frequency`);
  }
